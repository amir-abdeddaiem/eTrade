...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/shop-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:00:54 GMT -->
                        ...
                        <div class="axil-shop-sidebar">
                            ...
                            <div class="toggle-list product-categories active">
                                ...
                                <div class="shop-submenu">
                                    <ul>
                                        <?php	
                                            $sql = "SELECT * FROM scategories where cat_id = '$id'";
                                            $result = mysqli_query($conn, $sql);
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                                   echo '
                                        <li><a href="shop-s-category.php?id='.$row['id'].'">'.$row['scat_name'].'</a></li>
                                       ';}}?>
                                    </ul>
                                </div>
                            </div>
