            ...
            <div class="container">
                    ...
                    <div class="row">
                       <div class="col-lg-12 mb-5">
                            ...
                            <form method="post" action="scripts/category/add.php" >
                                <h5 class="title mb--20">Add Category</h5>
                                <div class="summery-table-wrap">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cat_img" value="">
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="axil-order-summery order-checkout-summery">
                                <h5 class="title mb--20">Categories List</h5>
                                <div class="summery-table-wrap">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                                   echo ' <tr class="order-product">
                                                    <td><img class="mr-5" src="images/'.$row['image'].'" style="height: 50px;">'.$row['cat_name'].'</td>
                                                    <td><a href="scripts/category/mod_cat.php?id='.$row['id'].'"><button type="button" class="btn btn-outline-warning " style="height:40px;width: 40px;"><i class="bi bi-pencil"></i></button></a>
                                                    <a href="scripts/category/delete.php?id='.$row['id'].'"><button type="button" class="btn btn-outline-danger " style="height:40px;width: 40px;"><i class="bi bi-trash3-fill" ></i></button></a></td>
                                                </tr>';
                                                }
                                            }
                                            ?>
