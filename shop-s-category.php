...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:00:54 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="header-campaign-activation axil-slick-arrow arrow-both-side header-campaign-arrow">
                            <div class="slick-slide">
                                <div class="campaign-content">
                                    <p>SIGN UP  NOW AND GET 10% OFF :  <a href="#">GET OFFER</a></p>
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="campaign-content">
    ...
    <main class="main-wrapper">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="inner">
                            <ul class="axil-breadcrumb">
                                <li class="axil-breadcrumb-item"><a href="index.html">u</a></li>
        ...
        <div class="axil-shop-area axil-section-gap bg-color-white">
            <div class="container">
                ...
                <?php	
                                            //get all categories
                                            $sql = "SELECT * FROM products WHERE scat_id = '$id'";
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            ...
                            <a href="detail-produit.php?id='.$row['id'].'">
                                    <img src="images/'.$row['image'].'" alt="Product Images">
                                </a>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:00:55 GMT -->
</html>