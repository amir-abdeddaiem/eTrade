                ...
                <div class="row">
                    <div class="col-lg-12 mb-5">
                        <div class="axil-order-summery order-checkout-summery">
                            <form method="post" action="scripts/produit/update.php?id=<?php echo $prod_id; ?>">
                                <h5 class="title mb--20">Update product</h5>
                                        ...
                                        <div class="col-6">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                                   ...
                                                   echo 'value="'.$row['id'].'">'.$row['cat_name'].'</option>
                                                   ';
                                                }
                                            }
                                            ?>
                                        ...
                                        <div class="col-6">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                                  ...
                                                  echo 'value="'.$row['id'].'">'.$row['scat_name'].'</option>
                                                   ';
                                                }
                                            }
                                            ?>
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="prod_desc" value="<?php echo $prod_desc; ?>">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input type="text" class="form-control" name="prix" value="<?php echo $prod_price; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Product image</label>
                                        <input type="text" class="form-control" name="prod_img" value="<?php echo $prod_img; ?>">
                                    </div>

                                </div>

                                <button type="submit" class="axil-btn btn-bg-primary submit-btn">Update</button>
                            </form>
                        </div>
                    </div>
