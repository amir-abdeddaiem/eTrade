...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/single-product-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:01:00 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-10 order-lg-2">
                                    <div class="single-product-thumbnail-wrap zoom-gallery">
                                        <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                            <div class="thumbnail">
                                                <a href="images/<?php echo $prod_img ;?>" class="popup-zoom">
                                                    <img src="images/<?php echo $prod_img ;?>" alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="images/<?php echo $prod_img ;?>" class="popup-zoom">
                                ...
                                <div class="col-lg-2 order-lg-1">
                                    <div class="product-small-thumb-3 small-thumb-wrapper">
                                        <div class="small-thumb-img">
                                            <img src="images/<?php echo $prod_img ;?>" alt="thumb image">
                                        </div>
                        ...
                        <div class="col-lg-5 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    <h2 class="product-title"><?php echo $prod_name; ?></h2>
                                    <span class="price-amount">$<?php echo $prod_price ;?></span>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href="single-product.html"><?php echo $prod_name ?></a></h5>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/single-product-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:01:01 GMT -->
</html>