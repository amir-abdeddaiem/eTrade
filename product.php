...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:01:04 GMT -->
                ...
                <div class="row">
                    <div class="col-lg-12 mb-5">
                        <div class="axil-order-summery order-checkout-summery">
                            <form method="post" action="scripts/produit/add_prod.php">
                                <h5 class="title mb--20">Add product</h5>
                                <div class="summery-table-wrap">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb--40">
                                                ...
                                                <select class="select2" name="scat_id">


                                                    <?php	
                                            //get all categories
                                            $sql = "SELECT * FROM scategories";
                                            $result = mysqli_query($conn, $sql);
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prod_desc" value="">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="prod_img" value="">
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="axil-order-summery order-checkout-summery">
                            <h5 class="title mb--20">Products List</h5>
                            <div class="summery-table-wrap">
                                <table class="table summery-table">
                                    ...
                                    <tbody>
                                        <?php	
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                                   echo ' <tr class="order-product">
                                                    <td><img src="images/'.$row['image'].'" style="height: 50px;">'.$row['prod_name'].'</td>
                                                    <td><a href="mod-prod.php?id='.$row['id'].'"><button type="button" class="btn btn-outline-warning " style="height:40px;width: 40px;"><i class="bi bi-pencil"></i></button></a>
                                                    <a href="scripts/produit/delete.php?id='.$row['id'].'"><button type="button" class="btn btn-outline-danger " style="height:40px;width: 40px;"><i class="bi bi-trash3-fill" ></i></button></a></td>
                                                </tr>';
                                                }
                                            }
                                            ?>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Dec 2022 12:01:05 GMT -->
