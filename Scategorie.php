                ...
                <div class="row">
                    <div class="col-lg-12 mb-5">
                        <div class="axil-order-summery order-checkout-summery">
                            <form method="post" action="scripts/Scategory/add.php">
                                <h5 class="title mb--20">Add Sub - Category</h5>
                                <div class="summery-table-wrap">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label>Sub Category name</label>
                                                <input type="text" class="form-control" name="scat_name" value="">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="scat_img" value="">
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="axil-order-summery order-checkout-summery">
                            <h5 class="title mb--20">Sub-category List</h5>
                            <div class="summery-table-wrap">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while($row = mysqli_fetch_assoc($result)) {
                                                   echo ' <tr class="order-product">
                                                    <td><img src="images/'.$row['image'].'" style="height: 50px;">'.$row['scat_name'].'</td>
                                                    <td><a href="scripts/Scategory/mod-scat.php?id='.$row['id'].'"><button type="button" class="btn btn-outline-warning " style="height:40px;width: 40px;"><i class="bi bi-pencil"></i></button></a>
                                                    <a href="scripts/Scategory/delete.php?id='.$row['id'].'"><button type="button" class="btn btn-outline-danger " style="height:40px;width: 40px;"><i class="bi bi-trash3-fill" ></i></button></a></td>
                                                </tr>';
                                                }
                                            }
                                            ?>
